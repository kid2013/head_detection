...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        /* IplImage* ori_img = cvLoadImage(input, CV_LOAD_IMAGE_COLOR); */
        /* image im = ipl_to_image(ori_img); */
        /* CvSize std_size = cvSize(net->w, net->h); */
        /* IplImage* re_img = cvCreateImage(std_size, IPL_DEPTH_8U, 3 ); */
        /* cvResize(ori_img, re_img, CV_INTER_AREA); */
        /* image sized = ipl_to_image(re_img); */
        /* cvReleaseImage(&ori_img); */
        /* cvReleaseImage(&re_img); */
        image im = load_image_color(input,0,0);
        image sized = letterbox_image(im, net->w, net->h);
        //image sized = cvResize_image(im, net->w, net->h);
